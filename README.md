...
Nesta live coding o [Rodrigo Peleias](https://github.com/rpeleias) desenvolveu um pequeno sistema para o gerenciamento de pessoas de uma empresa através de uma API REST, criada com o Spring Boot.
